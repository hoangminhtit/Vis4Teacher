    ...
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Thông tin về hệ thống quản lý lớp học</p>
        </div>
      </div>
      ...
      <div className="space-y-8">
        {/* System Info */}
        <div>
          <h3 className="text-xl font-semibold text-gray-800 mb-4">Hệ thống Vis4Teacher</h3>
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Dễ dàng quản lý thông tin các lớp chủ nhiệm</p>
                </div>
                <div className="bg-white rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Xem báo cáo và thống kê chi tiết</p>
                </div>
                <div className="bg-white rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Tương tác hiệu quả với sinh viên</p>
                </div>
            </div>
          </div>
        </div>
        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p><span className="font-medium">Địa chỉ:</span> 12 Nguyễn Văn Bảo, P.4, Q.Gò Vấp, TP.HCM</p>
                    <p><span className="font-medium">Điện thoại:</span> (028) 3894 0390</p>
                    <p><span className="font-medium">Email:</span> info@iuh.edu.vn</p>
                    <p><span className="font-medium">Website:</span> www.iuh.edu.vn</p>
                    </div>
                </div>
                <div className="bg-gray-50 rounded-lg p-6">
        ...
        <div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                ...
                <div className="space-y-2 text-sm">
                <p><span className="font-medium">Email hỗ trợ:</span> support.vis4teacher@iuh.edu.vn</p>
                <p><span className="font-medium">Hotline:</span> (028) 3894 0391</p>
                <p><span className="font-medium">Thời gian:</span> Thứ 2 - Thứ 6, 8:00 - 17:00</p>
                </div>
            </div>
        </div>
      </div>
